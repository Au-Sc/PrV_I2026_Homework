...
TEXTURES = {
    ...
    "dark_fire": pygame.image.load(BASE_DIR / "assets" / "graphics" / "dark_fire.png"),
...
FRAMES = {
    ...
    "boss": frames.generate_frames(TEXTURES["boss"], 24, 24),
    "dark_fire": frames.generate_frames(TEXTURES["dark_fire"], 16, 16),
